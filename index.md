...
<section class="safer-section text-center bg-primary color-white p-relative overflow-xl" id="visible-insured">
    <div class="container container-md pt-55 pt-xs-0 p-relative z-index-2">
        ...
        <p class="lh-160 mb-30">iTokens and pTokens are powerful financial primitives with endless possibilities. iTokens are tokens that represent your loans and constantly increase in value, while pTokens are tokens that represent your trades. These iTokens and pTokens can be sent to cold storage, used to collateralize loans, composed into complex financial products, or listed on both centralized and decentralized exchanges to instantly enable margin lending and trading.</p>
        <a href="/blog/governance-is-powerful-capturing-value-with-bzrx" class="button button-primary button-sm d-flex j-content-center m-auto">Introducing Fulcrum</a>
        <a href="/blog/governance-is-powerful-capturing-value-with-bzrx" class="button button-primary button-sm d-flex j-content-center m-auto">Introducing Fulcrum</a>
    </div>
